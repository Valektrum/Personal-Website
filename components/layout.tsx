  ...
  return (
    <>
      <Head>
        ...
        <meta name="Description" content="Patrick Morin's website" />
        <meta
          property="og:image"
        ...
        <>
          ...
          <div className={styles.logos}>
            <div className={styles.svg}>
              <a
                href="https://www.linkedin.com/in/patrick-morin-5209b719a/"
                target="_blank"
              >
                <svg
            ...
            <div className={styles.svg}>
              <a href="https://github.com/Valektrum" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
